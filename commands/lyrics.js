...
module.exports = {
    info: {
    name: "lyrics",
    description: "Get lyrics for the currently playing song/ Obtener la letra de la cancion actual",
    usage: "[lyrics]",
    aliases: ["ly"],
    },
    ...
    run: async function (client, message, args) {
        ...
        if (!queue) return sendError("There is nothing playing.No hay nada reproducido en este servidor.", message.channel).catch(console.error);
