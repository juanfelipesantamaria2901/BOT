...
module.exports = {
  info: {
    name: "volume",
    description: "To change the server song queue volume/Para cambair el nivel de volumen de la musica",
    usage: "[volume]",
    aliases: ["v", "vol"],
  },
  ...
  run: async function (client, message, args) {
    ...
    if (!serverQueue) return sendError("There is nothing playing in this server.No hay nada reproduciendo en este servidor.", message.channel);
    if (!serverQueue.connection) return sendError("There is nothing playing in this server.No hay nada reproduciendo en este servidor", message.channel);
